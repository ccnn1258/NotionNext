...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '年糕', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '年更是你的谣言', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ccnn1258.top', // 网站地址
